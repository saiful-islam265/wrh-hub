	...
	<div class="dashboard-page__order">
		<div class="dashboard-page__order-header">
			<div class="navbar-header">
				<h6 class="title"><?php esc_html_e( 'Completed Ventilation', 'hoodslyhub' ); ?></h6>
			</div>
		...
		<div class="dashboard-page__order-body" id="vent-completed-list">
			<table class="table table-order">
				...
				<tr>
					...
					<th scope="col"><?php esc_html_e( 'Shop', 'hoodslyhub' ); ?></th>
					<th scope="col"><?php esc_html_e( 'Estimated Shipping Date', 'hoodslyhub' ); ?></th>
					<th scope="col"><?php esc_html_e( 'Order Source', 'hoodslyhub' ); ?></th>
					<th scope="col"><?php esc_html_e( 'Ventilation SKU', 'hoodslyhub' ); ?></th>
					<th scope="col"><?php esc_html_e( 'Actions', 'hoodslyhub' ); ?></th>
				</tr>
				</thead>
				<tbody>
				<?php
			...
			<div class="hub-pagination" id="ventcompletedPaginate" data-max_num_pages="<?php echo $all_orders->max_num_pages; ?>">
				<?php
