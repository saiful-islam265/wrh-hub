	...
	<div class="dashboard-page__order">
		<div class="dashboard-page__order-header">
			<div class="navbar-header">
				<h6 class="title"><?php echo esc_html__( 'Damage Claim', 'hoodslyhub' ); ?></h6>
			</div>
				...
				if ( $all_orders->have_posts() ) {
					...
					while ( $all_orders->have_posts() ) {
						...
						<tr style="background-color: #4747471a;">
							...
							<td class="files" data-title="Files" data-toggle="collapse" data-target="#cliam-<?php echo esc_html( $order_id ); ?>"
								aria-expanded="false" aria-controls="cliam-<?php echo esc_html( $order_id ); ?>">
						...
						<tr class="cliam-collapse">
							<td colspan="12">
								<div class="cliam-collapse__body collapse" id="cliam-<?php echo esc_html( $order_id ); ?>">
									<div class="row">
